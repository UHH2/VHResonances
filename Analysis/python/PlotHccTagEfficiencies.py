...
class PlotHccTagEfficiencies(VariablesBase):
    def __init__(self):
        ...
        # self.defaultCut  = "ExtraCleaning"
        # self.Cuts        = ["Selection", "ExtraCleaning"]
        self.defaultCut  = "PTMassCut"
        self.Cuts        = ["PTMassCut"]
        self.Flavours    = ["Hcc", "HccMD"]
        self.Modes       = ["tot", "Twp", "Mwp", "Lwp"]
        self.histos      = {}

        self.Channels.remove('invisible')
    ...
    def LoadHistos(self):
        for year in self.years:
            ...
            for channel in self.Channels:
                # filename = self.Path_STORAGE+year+"/SignalRegion/Puppi/"+channel+"channel/nominal/"+self.PrefixrootFile+"MC."+self.Signal+"_"+year+"_noTree.root"
                # filename = self.Path_STORAGE+year+"/SignalRegion/Puppi/"+channel+"channel/nominal/"+self.PrefixrootFile+"MC."+self.Signal+"_M3000_"+year+"_noTree.root"
