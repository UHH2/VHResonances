            ...
            for channel in self.Channels:
                ...
                for collection in self.Collections:
                    for sample in self.SignalSamples:
                        ...
                        if self.xmin!=-1 or self.xmax!=-1:
                            canv.SaveAs(self.outdir+"SignalShape_"+year+"_"+channel+"_"+collection+"_"+sample+"_"+str(self.xmin)+"_"+str(self.xmax)+".pdf")
                        else:
                            canv.SaveAs(self.outdir+"SignalShape_"+year+"_"+channel+"_"+collection+"_"+sample+".pdf")
