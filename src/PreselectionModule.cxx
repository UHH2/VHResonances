...
PreselectionModule::PreselectionModule(uhh2::Context& ctx){
  ...
  JetDiLeptonPhiAngularSel.reset(new JetDiLeptonPhiAngularSelection(min_jet_dilep_pt, min_jet_dilep_delta_phi, max_jet_dilep_delta_phi, MS["leptons"], h_topjets));
