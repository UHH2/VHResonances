...
ScaleFactors_map = {//std::pair(filename,histname)
  ...
  { "UL16preVFP", {
    { "Muon_Reconstruction",      std::pair("Muon_Reconstruction_SF_UL16", "Reconstruction_SF")},
    { "Muon_HighPtID",            std::pair("muonefficiencies/Run2/UL/2016_preVFP/2016_preVFP_Z/Efficiencies_muon_generalTracks_Z_Run2016_UL_HIPM_ID", "NUM_HighPtID_DEN_TrackerMuons_abseta_pt")},
  ...
  { "UL16postVFP", {
    { "Muon_Reconstruction",      std::pair("Muon_Reconstruction_SF_UL16", "Reconstruction_SF")},
    { "Muon_HighPtID",            std::pair("muonefficiencies/Run2/UL/2016_postVFP/2016_postVFP_Z/Efficiencies_muon_generalTracks_Z_Run2016_UL_ID", "NUM_HighPtID_DEN_TrackerMuons_abseta_pt")},
  ...
  { "UL17", {
    { "Muon_Reconstruction",      std::pair("Muon_Reconstruction_SF_UL17", "Reconstruction_SF")},
    { "Muon_HighPtID",            std::pair("muonefficiencies/Run2/UL/2017/2017_Z/Efficiencies_muon_generalTracks_Z_Run2017_UL_ID", "NUM_HighPtID_DEN_TrackerMuons_abseta_pt")},
  ...
  { "UL18", {
    { "Muon_Reconstruction",      std::pair("Muon_Reconstruction_SF_UL18", "Reconstruction_SF")},
    { "Muon_HighPtID",            std::pair("muonefficiencies/Run2/UL/2018/2018_Z/Efficiencies_muon_generalTracks_Z_Run2018_UL_ID", "NUM_HighPtID_DEN_TrackerMuons_abseta_pt")},
