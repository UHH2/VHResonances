...
private:
  ...
  "btag_DeepBoosted_H4qvsQCD", "btag_MassDecorrelatedDeepBoosted_H4qvsQCD", "btag_DeepBoosted_HccvsQCD", "btag_MassDecorrelatedDeepBoosted_HccvsQCD"};
  ...
  "btag_DeepBoosted_HbbvsHcc", "btag_DeepBoosted_HvsQCD", "btag_DeepBoosted_probHqqqq", "btag_DeepBoosted_raw_score_h", "btag_MassDecorrelatedDeepBoosted_probHqqqq" };
